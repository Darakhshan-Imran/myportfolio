...
const About = () => {
  return (
    <section className="bg-cover bg-gradient-to-r from-[#11091c] to-[#270927] min-h-screen w-screen overflow-x-hidden flex flex-col items-center pt-4 mx-0 px-0 sm:px-6 md:px-8">
      ...
      <p className="text-base md:text-xl lg:text-md text-slate-50 font-medium italic leading-7 md:leading-9 mt-8 md:mt-12 sm:mt-8 px-7 sm:px-8 md:px-6 lg:px-4 mx-2 text-justify justify-center sm:text-wrap sm:overflow-hidden">
